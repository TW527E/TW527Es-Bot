...
class Main(Cog_Extension):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name="-------------------", value="指令幫助指令", inline=False)
    ...
    async def help2(self, ctx):
        ...
        embed.set_thumbnail(url="https://images-na.ssl-images-amazon.com/images/I/31ORJ91xCUL._SY355_.jpg")
        embed.add_field(name="備註", value="指令前方加上* = 僅擁有*管理者*權限的人可使用指令 不代表管理員可以用", inline=False)
        ...
        embed.add_field(name="-------------------", value="插件", inline=True)
        embed.add_field(name="Main", value="基本", inline=False)
        embed.add_field(name="Message", value="訊息", inline=True)
